...
class Client:
    ...
    def do_http_request(
        self, relative_url, parameters=None, method="GET", upload_file_stream=None
    ):
    ...
    def project_create(
        self, project_group_id, project_type, name=None, description=None
    ):
        relative_url = "project-groups/{}/projects".format(project_group_id)
        params = {
    ...
    def file_upload(
        ...
        with open(file_name, "rb") as file_stream:
            return self.do_http_request(
                relative_url, params, method="POST", upload_file_stream=file_stream
            )
    ...
    def translation_export(
        self, project_id, locale, source_file_name, export_file_name=None
    ):
