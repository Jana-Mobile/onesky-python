...
class ClientTestCase(unittest.TestCase):
    ...
    def execute_with_parameters(
        ...
        try:
            ...
            if "{}" in expected_url:
                ...
                expected_absolute_url = expected_absolute_url.format(*substitutions)

            self.assertEqual(
                callback_results.get("absolute_url"), expected_absolute_url
            )
            ...
            self.assertEqual(result_params["dev_hash"], expected_hash.hexdigest())
    ...
    def test_project_group_list(self):
        self.execute(
            "project_group_list", "GET", "project-groups", [], ["page", "per_page"]
        )

    def test_project_group_show(self):
        self.execute(
            "project_group_show", "GET", "project-groups/{}", ["project_group_id"]
        )

    def test_project_group_create(self):
        self.execute(
            "project_group_create", "POST", "project-groups", ["name"], ["locale"]
        )

    def test_project_group_delete(self):
        self.execute(
            "project_group_delete", "DELETE", "project-groups/{}", ["project_group_id"]
        )

    def test_project_group_languages(self):
        self.execute(
            "project_group_languages",
            "GET",
            "project-groups/{}/languages",
            ["project_group_id"],
        )
    ...
    def test_project_show(self):
        self.execute("project_show", "GET", "projects/{}", ["project_id"])
    ...
    def test_project_delete(self):
        self.execute("project_delete", "DELETE", "projects/{}", ["project_id"])

    def test_project_languages(self):
        self.execute(
            "project_languages", "GET", "projects/{}/languages", ["project_id"]
        )
    ...
    def test_file_delete(self):
        self.execute(
            "file_delete", "DELETE", "projects/{}/files", ["project_id", "file_name"]
        )
    ...
    def test_order_show(self):
        self.execute(
            "order_show", "GET", "projects/{}/orders/{}", ["project_id", "order_id"]
        )
